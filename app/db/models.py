...
class PaperTrade(Base):
    ...
    strategy_name: Mapped[str] = mapped_column(String(64), default="auto_opportunity", index=True)
    ...
    capital_allocated: Mapped[float] = mapped_column(default=0.0)
    current_price: Mapped[float] = mapped_column()
    max_seen_price: Mapped[float] = mapped_column()
    min_seen_price: Mapped[float] = mapped_column()
    target_1_price: Mapped[float] = mapped_column()
    target_2_price: Mapped[float] = mapped_column()
    stop_price: Mapped[float] = mapped_column()
    close_price: Mapped[float | None] = mapped_column(nullable=True)
    current_return_percent: Mapped[float] = mapped_column(default=0.0)
    max_intraday_return_percent: Mapped[float] = mapped_column(default=0.0)
    min_intraday_return_percent: Mapped[float] = mapped_column(default=0.0)
    hit_2_percent: Mapped[bool] = mapped_column(default=False)
    hit_3_percent: Mapped[bool] = mapped_column(default=False)
    hit_limit_up: Mapped[bool] = mapped_column(default=False)
    stop_hit: Mapped[bool] = mapped_column(default=False)
    profit_protected: Mapped[bool] = mapped_column(default=False)
    realized_percent: Mapped[float] = mapped_column(default=0.0)
    realized_price: Mapped[float | None] = mapped_column(nullable=True)
    realized_return_percent: Mapped[float] = mapped_column(default=0.0)
    protected_stop_price: Mapped[float | None] = mapped_column(nullable=True)
    source_scan_payload: Mapped[dict] = mapped_column(JSON, default=dict)
